...
import (
	...
	"rbackup/internal/backend"
	"rbackup/internal/cache"
	"rbackup/internal/crypto"
	"rbackup/internal/debug"
	"rbackup/internal/errors"
	"rbackup/internal/index"
	"rbackup/internal/pack"
...
func (r *Repository) CreateIndexFromPacks(ctx context.Context, packsize map[restic.ID]int64) (invalid restic.IDs, err error) {
	var m sync.Mutex
